...
repos_filtered <- repos_filtered[!(repos_filtered$language %in% domain_specific_langs), ]
repos_filtered <- repos_filtered[!(repos_filtered$language %in% markup_langs), ]
language_occurences <- table(unlist(repos_filtered$language))
repos_filtered <- repos_filtered[language_occurences[unlist(repos_filtered$language)] > 10, ]
